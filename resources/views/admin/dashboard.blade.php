...
<div class="container">
    ...
    <div class="row">
            <div class="col-sm-6">
                <a name="" id="" class="btn btn-block btn-default" href="#" role="button">Создать категорию</a>
            ...
            <div class="col-sm-6">
                    <a name="" id="" class="btn btn-block btn-default" href="#" role="button">Создать Материал</a>
